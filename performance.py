...
def generate_random_inputs(a, b):
    ...
    ----------
    a: int or float
       Sets the first dimension of the array
    
    b: int or float
       Sets the second dimension of the array
    
    Returns
    -------
    random_array: list of arrays
       Returns random values of the given shape (a, b) as an array
    """
...
def random_array(feature):
    ...
    -------
    input_data: array
       Returns the randomly generated features of a and b, using the `generate_random_inputs` function
    
    c: array
       The generated weights. Also makes use of the `generate_random_inputs` function
    """
...
def speed(feature):
    ...
    Parameters
    ----------
    feature: list of arrays
        The array for which the analysis is carried out on
    
    Returns
    -------
    res: list of arrays
        An array which gives the d-index from the algorithm calculation
    """
